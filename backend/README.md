# Webnetter API
Webnetter-API is a Network Mangement Tool designed for web-applications.

This API is able to communicate and configure data on all types of network machines.
Communications is made with [Basic Auth(RFC7617)](https://tools.ietf.org/html/rfc7617).

Requests towards the API is returned in great(Not perfect) json structure for frontend developers to manipulate and use.
