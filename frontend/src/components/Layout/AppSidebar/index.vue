    ...
    >
        <v-row>
            <v-col cols="12" class="text-center">
                <transition name="fade" style="transition-delay: 151s">
                    <div
                        v-if="!mini"
        ...
        <template #append>
            <v-divider />
            <v-list>
                <v-list-item href="https://github.com/codekuu/" target="_blank">
                    <v-list-item-content> Made by codekuu </v-list-item-content>
                </v-list-item>
            </v-list>
        </template>
    </v-navigation-drawer>
